...
if (uTextEnabled > 0.5) {
    /*
     * metadata.z is the SAME deterministic population
     * generated by WhatIBuild.jsx.
     *
     * This prevents the formation damping from creating
     * another independent population.
     */
...
velocity.z +=
    ...
    textFormationDamping;
        ...
        if (uTextEnabled > 0.5) {
            ...
            /*
 * ============================================================
 * ONE PARTICLE POPULATION
 * ============================================================
 *
 * WhatIBuild.jsx uses this exact deterministic population
 * when writing glyph targets into the text DataTexture.
 *
 * metadata.z carries that population into the GPU.
 *
 * Therefore:
 *
 *     metadata.z < 0.34
 *
 * means this exact particle is a TEXT particle.
 *
 * There is no second phase-derived text population.
 */
 ...
 * for organic/deconstruction behaviour INSIDE the already
 * selected text population.
 *
 * It is NOT used to decide who forms the text.
 */
float personality =
    fract(
        sin(
